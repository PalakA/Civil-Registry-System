...
public class DisplayMarriage {
	public static List<UserMarriage> disp(String husname,String wifename) {
		int status = 0;
		...
		try {
			...
			ResultSet rs = stmt
					.executeQuery("select * from marriagerecord where husbandName='"
							+ husname + "'and wifeName='" + wifename + "'");
