...
<body>
    ...
    <div id="nav">
     ...
     <!-- content area-->
	    <div class="content">
		<form action="/CivilRegister/JSP/welcome.jsp" method="post">
		
			<center>
			<img style="float: center;" src="/CivilRegister/images/feeds.jpg"/>
				<font size="6" face=Candara><br> <br><b>You
						Have Successfully Registered Your Feedback</b><br> 
				</font>
				<font size="4" face=Candara><br> <br> <b>We will get back to you with your query within 5 working days</b><br> <br>
				</font>
			</center>
